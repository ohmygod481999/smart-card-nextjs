...
const Settings: NextPage = () => {
    ...
    return (
        <>
            <Head>
                <title>
                    Smartcardnp - Profile Management and Security Settings
                </title>
                <meta
                    name="description"
                    content="NextJS + React + Vercel + Ory"
                />
            </Head>
            <CardTitle style={{ marginTop: 80 }}>Cài đặt bảo mật</CardTitle>
            ...
            <SettingsCard only="lookup_secret" flow={flow}>
                ...
                <Messages messages={flow?.ui.messages} />
                <P>
                    Recovery codes can be used in panic situations where you
                    have lost access to your 2FA device.
                </P>
            ...
            <SettingsCard only="webauthn" flow={flow}>
                ...
                <Messages messages={flow?.ui.messages} />
                <P>
                    Use Hardware Tokens (e.g. YubiKey) or Biometrics (e.g.
                    FaceID, TouchID) to enhance your account security.
                </P>
                <Flow
                    hideGlobalMessages
                    onSubmit={onSubmit}
