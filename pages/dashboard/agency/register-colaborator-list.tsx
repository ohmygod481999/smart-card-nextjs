...
import { GET_AGENCY_REGISTRATIONS_ADMIN, GET_COLABORATOR_REGISTRATIONS_ADMIN } from "../../../utils/apollo/queries/registration.queries";
...
function AgencyAdmin() {
    ...
    const { data, loading, error, refetch } = useQuery(
        GET_COLABORATOR_REGISTRATIONS_ADMIN,
        {
            variables: {
                limit: 1000,
                offset: 0,
    ...
    const approveColaboratorHandler = useCallback(async (agencyRegister: any) => {
            ...
            <div className="container-fluid">
                ...
                <div className="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 className="h3 mb-0 text-gray-800">
                        Danh sách đăng ký cộng tác viên
                    </h1>
                    {/* <a
                        href="#"
