...
const Home: NextPage = () => {
  ...
  return (
    ...
    >
      <header>
        <div className={`header__container ${headerActive ? "active" : ""}`}>
        ...
        <div className={`header__navbar ${navbarActive ? "active" : ""}`}>
      ...
      <main>
        <div className="hero">
          <div className="hero__content">
            ...
            <div className="content__btns">
              <button className="btn__request">Request For Demo</button>
          ...
          <div className="hero__images">
            <img className="hero__image" src="/images/hero-1.png" alt="" />
          </div>
        </div>
        <div className="feature">
          <p className="feature__title">With all the Features You Need</p>
        ...
        <div className="why-choose-us">
          <div className="item1">
            <div className="container">
              <div className="left">
                ...
                <p className="title">Advanced Analytics, Understand Business</p>
                ...
                <div className="lists">
                  <ul className="list1">
                    <li>
                      <AiFillCheckCircle /> <p>Thought leadership</p>
                    </li>
                    <li>
                      <AiFillCheckCircle /> <p>Personal branding</p>
                    </li>
                    <li>
                      <AiFillCheckCircle /> <p>Modernized prospecting</p>
                    </li>
                  </ul>
                  <ul className="list2">
                    <li>
                      <AiFillCheckCircle /> <p>Better win rates</p>
                    </li>
                    <li>
                      <AiFillCheckCircle /> <p>Showcasing success</p>
                    </li>
                    <li>
                      <AiFillCheckCircle /> <p>Sales compliance</p>
                    </li>
                  </ul>
                </div>
              </div>
          ...
          <div className="item2">
            <div className="left">
              ...
              <p className="title">Match Everything to Brand and Style</p>
              <p className="description">
        ...
        <div className="customer__review">
          ...
          <div className="quote">
            ...
            <div className="title">The Best Template You Got to Have it!</div>
